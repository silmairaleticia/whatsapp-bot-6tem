...
// perguntas e no final manda direto pro checkout da Kiwify. As respostas + contato
// são salvos como lead em /inbox/leads mesmo se a pessoa não finalizar a compra.
                        ...
                        h1{font-size:22px;margin:0 0 8px}
                          h2{font-size:20px;margin:0 0 8px}
                            p.sub{color:var(--muted);font-size:14px;margin:0 0 20px}
                              .opt{display:block;width:100%;text-align:left;padding:14px 16px;margin-bottom:10px;border:1.5px solid var(--border);border-radius:12px;background:#fff;font-size:15px;cursor:pointer;transition:.15s}
                                .opt:hover{border-color:var(--green);background:#f0fdf4}
                                  input[type=text],input[type=tel]{width:100%;padding:14px;border-radius:12px;border:1.5px solid var(--border);font-size:15px;margin-bottom:12px}
                                    .btn{display:block;width:100%;padding:16px;background:var(--green);color:#fff;border:none;border-radius:100px;font-size:16px;font-weight:700;cursor:pointer;text-align:center;text-decoration:none}
                                      .trust{background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:14px;margin:16px 0;font-size:14px;line-height:1.8}
                                                                                                                                      ...
                                                                                                                                      var pct = Math.min(100, Math.round((current / totalSteps) * 100));
                                                                                                                                        ...
                                                                                                                                        function renderQuestion() {
                                                                                                                                          var q = QUESTIONS[current];
                                                                                                                                            var html = '<h1>' + q.text + '</h1><p class="sub">Pergunta ' + (current + 1) + ' de ' + QUESTIONS.length + '</p>';
                                                                                                                                              q.options.forEach(function (opt, i) {
                                                                                                                                                  html += '<button class="opt" onclick="answerQuestion(' + i + ')">' + opt + '</button>';
                                                                                                                                                    });
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            '&#10003; Acesso vitalício, no seu ritmo<br>' +
                                                                                                                                                                                                                                                                                '&#10003; Garantia de 7 dias<br>' +
                                                                                                                                                                                                                                                                                    '&#10003; Não precisa largar o emprego atual' +
                                                                                                                                                                                                                                                                                        '</div>' +
                                                                                                                                                                                                                                                                                            '<p class="muted">Investimento único</p>' +
                                                                                                                                                                                                                                                                                                '<div class="price">R$97</div>' +
                                                                                                                                                                                                                                                                                                    '<a class="btn" href="${CHECKOUT_URL}">Quero começar agora</a>';
                                                                                                                                                                                                                                                                                                      renderProgress();
                                                                                                                                                                                                                                                                                                      }
